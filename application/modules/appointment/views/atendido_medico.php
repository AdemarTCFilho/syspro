    ...
    <section class="wrapper site-min-height">
        ...
        <section class="panel">
            <header class="panel-heading">
                <a class="btn btn-primary" href="JavaScript: window.history.back();"><i class="fa fa-mail-reply"> </i> Voltar</a> <i class="fa fa-user"></i>  <?php echo lang('appointments'); ?> | <?php echo $mmrdoctor->name; ?> | 
