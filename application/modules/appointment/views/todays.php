    ...
    <section class="wrapper site-min-height">
        ...
        <section class="panel">
            ...
            <div class="panel-body row">
                <div class="adv-table edi_table-table col-md-12">
                    <div class="clearfix">
                    ...
                    <form class="form-horizontal">
                      <div class="form-group has-success has-feedback">                       
                        ...
                        <div class="col-sm-3">
                            <a href="appointment/upcoming" class="btn card-cor-cinza"><i class="fa fa-list-alt"></i> <?php echo lang('upcoming'); ?></a>
                        </div>
                        <div class="col-sm-3">
                        ...
                        if ($appointment->date == strtotime(date('Y-m-d'))) {
                            ...
                            <tr class="">
                                ...
                                <td>
                                    ...
                                    <form method="POST" action="appointment/todays">
                                        <a class="historico-padding" href="patient/medicalHistory?id=<?php echo $this->db->get_where('patient', array('id' => $appointment->patient))->row()->id; ?>">
                                            <strong><?php echo $this->db->get_where('patient', array('id' => $appointment->patient))->row()->name; ?></strong>
                                        </a>
                                        <input style="display: none;" type="text" name="nome" value='<?php echo $this->db->get_where('patient', array('id' => $appointment->patient))->row()->name; ?>'>

                                        <input style="display: none;" type="text" name="consultorio" value='<?php echo $this->db->get_where('doctor', array('id' => $appointment->doctor))->row()->consultorio; ?>'>

                                        <input style="display: none;" type="text" name="medico" value='<?php echo $this->db->get_where('doctor', array('id' => $appointment->doctor))->row()->name; ?> | <?php echo $this->db->get_where('doctor', array('id' => $appointment->doctor))->row()->profile; ?>'>

                                        <?php if ($this->ion_auth->in_group(array('Doctor'))) { ?>
                                        <button type="submit" name="enviar" class="btn btn-xs" title="Chamar paciente" style="float: right;" onclick="ajax();"><i class="fa fa-volume-up" style="font-size:18px;color:#000000;float: right;"></i></button>
                                        <?php } ?>
                                    ...
                                    if (isset($_POST['enviar'])) {
                                        ...
                                        $consulta = "INSERT INTO chamar (nome, consultorio, medico) VALUES ('$nome', '$consultorio', '$medico')";
                    ...
                    <div class="col-md-12 panel">
                        ...
                        <div class="col-md-9"> 
                            <select class="form-control m-bot15 js-example-basic-single pos_select" id="pos_select" name="patient" value=''> 
                                ...
                                ?> >Cód: <?php echo $patient->id; ?> | <?php echo $patient->name; ?> | SUS: <?php echo $patient->sus; ?></option>
                                <?php } ?>
                            </select>
                        </div>
                    </div>
