    ...
    <section class="wrapper site-min-height">
        ...
        <section class="">
            <header class="panel-heading">
             <a class="btn btn-primary no-print" href="JavaScript: window.history.back();"><i class="fa fa-mail-reply"> </i> Voltar</a> <i class="fa fa-medkit"></i>  Receita | <?php echo $patient->name; ?> | <?php echo $patient->phone; ?>
         </header> 
         <div class="row ">
            <div class="">
                    ...
                    <div class=" col-md-8">
                        ...
                        <!--<?php foreach ($prescriptions as $department) { ?>
                            ...
                            <?php } ?>-->
                                ...
                                <div class="form-group">
                                    <label class="text-right control-label col-md-3">Receita:</label>
                                    <div class="col-md-9">
                                        <textarea class="" name="receita" value="" rows="30" cols="85"></textarea>
                                    </div>
                                </div>
                            ...
                            <section class="">
                                <button type="submit" name="submit" class="btn btn-info submit_button no-print" onclick="javascript:window.print();">Fechar/Assinar</button>
                                <a class="btn btn-info invoice_button no-print" onclick="javascript:window.print();"><i class="fa fa-print"></i> <?php echo lang('print'); ?> </a>
                            </section>
                        </form>
                    </div> 
                    <div class="no-print" style="width: 320px; height: 800px; overflow-y: scroll;">
                        <div class="adv-table editable-table col-md-2">
                            <br>
                            <table class="table table-striped table-hover table-bordered" id="">
                                <thead>
                                    <tr style="font-size: 10px;">

                                        <th><i class="fa fa-medkit" style="font-size:18px"></i>  Receitas</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    ...
                                    <tr class="">
                                        <td class="row">
                                            ...
                                            <a style="font-size: 10px;" class="btn btn-xs btn_width col-md-2" href="prescription/viewPrescriptionMedecine?id=<?php echo $prescription->id; ?>">
